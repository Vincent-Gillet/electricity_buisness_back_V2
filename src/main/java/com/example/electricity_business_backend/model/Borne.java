...
public class Borne {
    ...
    private EtatBorneEnum etatBorne;
...
/*    public Borne() {}
    ...
    public Borne(String nomBorne, double latitude, double longitude, BigDecimal tarif, int puissance, String instruction, Boolean surPied, EtatBorneEnum etatBorne) {
